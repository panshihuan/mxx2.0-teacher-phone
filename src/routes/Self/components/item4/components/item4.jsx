...
export default class Item4 extends React.Component {
        ...
        return (
            <div className="selfOnly mTp">
                ...
                <div className="login-phone">
                    <input ref="email" type="text" placeholder="输入新手机"/>
                </div>
                <div className="login-validate">
                    <label>
                        <input ref="code" type="text" placeholder="手机验证码"/>
                    </label>
    ...
    changeYan(){
        ...
        fetch(`http://115.29.177.200:8080/captcha/create`, {
            method: 'POST',
            headers: {
    ...
    sure(event){
        ...
        if(confirm('确认修改?')){
            fetch(`http://115.29.177.200:8080/modify/phone?token=${this.props.tokens}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
